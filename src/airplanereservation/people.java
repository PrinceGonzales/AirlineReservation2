...
public class people {
    ...
    public people(String name,int age,String address,String phonenumber,String email,String tarrifs,String schedule,String ticketcode,int column,int row,String Aclass){
